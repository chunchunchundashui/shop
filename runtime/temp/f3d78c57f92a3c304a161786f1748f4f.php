    ...
    <div class="article-main">
      ...
      <div class="am-bd">
        <ul class="artilce-list">
          ...
          <li>
            <h3><a href="<?php echo url('index/article/index', array('id' => $art['id'])); ?>" title="<?php echo $art['title']; ?>"><?php echo $art['title']; ?></a></h3>
          </li>
          <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
      </div>
