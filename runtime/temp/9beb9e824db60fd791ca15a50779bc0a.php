                    ...
                    <form class="form-horizontal" role="form" action=""  method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="cate_id">
                                ...
                                <option  <?php if(in_array(($vo['id']), explode(',',"1,2"))): ?> disabled="disabled" <?php endif; ?> value="<?php echo $vo['id']; ?>"> <?php echo str_repeat('-', $vo['level']*8)?><?php echo $vo['cate_name']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio" style="float:left; padding-right: 10px;">
                                    <label>
                                        <input type="radio" id="show_top" name="show_top" value="1" class="colored-blue">
                                        <span class="text">是</span>
                                    </label>
                                </div>
                                <div class="radio" style="float:left;">
                                    <label>
                                        <input type="radio" name="show_top" value="0" checked="checked" class="colored-blue">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea name="keywords" style="width: 100%;" id="keywords" cols="30" rows="10" class=""></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="description" class="col-sm-2 control-label no-padding-right">描述</label>
                            <div class="col-sm-6">
                                <textarea name="description" style="width: 100%;" id="description" cols="30" rows="10" class=""></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="link_url" placeholder="" name="link_url"  type="text">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea name="content" id="article_content" cols="30" rows="10" class=""></textarea>
                            </div>
                        </div>
