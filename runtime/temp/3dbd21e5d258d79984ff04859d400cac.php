            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                        <?php if(is_array($imgRes) || $imgRes instanceof \think\Collection || $imgRes instanceof \think\Paginator): $i = 0; $__LIST__ = $imgRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        <tr>
                            <th><img src="<?php echo $vo; ?>" height="100"></th>
                            <td align="center">
                                <a href="javascript:;" class="btn btn-danger article_del btn-sm shiny" dataid="<?php echo $vo; ?>">删除</a>
                            </td>
                        </tr>
        ...
        $(function () {
           $('.article_del').click(function () {
               ...
               layer.confirm('确定要删除吗?', {
                   ...
                   layer.close(index);
                   $.ajax({
                       url:"<?php echo url('article/delimg'); ?>",
                       type:'post',
                       data:{imgsrc:imgsrc},
                       dataType:'json',
