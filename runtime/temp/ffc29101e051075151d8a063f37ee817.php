        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('categoryAd/lst'); ?>">图片管理</a>
                    </li>
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action=""  method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="category_id" class="col-sm-2 control-label no-padding-right">关联栏目名称</label>
                                            <div class="col-sm-6">
                                                <select name="category_id" id="category_id">
                                                    <option value="">请选择</option>
                                                    <?php if(is_array($cateRes) || $cateRes instanceof \think\Collection || $cateRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cateRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
                                                    <option <?php if($CategoryAd['category_id'] == $cate['id']): ?> selected="selected"<?php endif; ?> value="<?php echo $cate['id']; ?>"><?php echo $cate['cate_name']; ?></option>
                                        ...
                                        <div class="form-group">
                                            <label for="img_src" class="col-sm-2 control-label no-padding-right">关联图</label>
                                            <div class="col-sm-6">
                                                <input  placeholder="" id="img_src" name="img_src"  type="file">
                                                <?php if($CategoryAd['img_src']): ?>
                                                    <img src="/shop/public/static/pro_img/<?php echo $CategoryAd['img_src']; ?>" alt="" width="100" height="100">
                                                <?php else: ?>
                                                    无缩略图
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label for="link_url" class="col-sm-2 control-label no-padding-right">关联地址</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="link_url" placeholder="" name="link_url" value="<?php echo $CategoryAd['link_url']; ?>"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="position" class="col-sm-2 control-label no-padding-right">图片位置</label>
                                            <div class="col-sm-6">
                                                <select name="position" id="position">
                                                    ...
                                                    <option <?php if($CategoryAd['position'] == 'C'): ?> selected="selected" <?php endif; ?> value="C">C</option>
                                                </select>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
