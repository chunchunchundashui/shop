    ...
    <script>
        $(function () {
            $('#Type_Add').click(function () {
                $.ajax({
                    url:"<?php echo url('MemberLevel/add'); ?>",
                    type:'post',
                    data:$('form').serialize(),
                    dataType:'json',
