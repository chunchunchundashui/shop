<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"D:\phpStudy\WWW\shop\public/../application/index\view\cate\cate.htm";i:1591796254;s:59:"D:\phpStudy\WWW\shop\application\index\view\common\head.htm";i:1591531505;s:64:"D:\phpStudy\WWW\shop\application\index\view\common\cate_left.htm";i:1591536341;s:61:"D:\phpStudy\WWW\shop\application\index\view\common\footer.htm";i:1591797092;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="content article-content">
  ...
  <dl class="article-menu">
    ...
    <dd class="am-c">
      <div class="menu-item active">
        ...
        <ul class="item-bd">
          ...
          <li><a href="<?php echo url('Cate/index', array('id' => $cate['id'])); ?>"><?php echo $cate['cate_name']; ?> </a></li>
    ...
    <dd class="am-c">
      ...
      <div class="menu-item active">
        <div class="item-hd"><a href="<?php echo url('Cate/index', array('id' => $cate['id'])); ?>"><?php echo $cate['cate_name']; ?></a><i class="iconfont icon-down"></i></div>
        ...
        <ul class="item-bd">
          ...
          <li><a href="<?php echo url('Cate/index', array('id' => $childCate['id'])); ?>"><?php echo $childCate['cate_name']; ?></a></li>
          <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
        <?php endif; ?>
      </div>
    ...
    <div class="article-main">
      ...
      <div class="am-bd">
        <ul class="artilce-list">
          ...
          <li>
            <h3><a href="<?php echo url('article/index', array('id' => $art['id'])); ?>" title="<?php echo $art['title']; ?>"><?php echo $art['title']; ?></a></h3>
          </li>
          <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
      </div>
			...
			<div class="help-list">
				...
				<div class="help-item">
					...
					<ul>
						...
						<li><a href="<?php if($arts['link_url']): ?> <?php echo $arts['link_url']; else: ?><?php echo url('article/index', array('id' => $arts['id'])); endif; ?>"><?php echo $arts['title']; ?></a></li>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
				</div>
				<?php endforeach; endif; else: echo "" ;endif; ?>
