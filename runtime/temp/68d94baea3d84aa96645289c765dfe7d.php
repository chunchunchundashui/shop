                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <select>
                                                    <option value="">请选择</option>
                                                    <option value="">40G</option>
                                                    <option value="">80G</option>
                                                </select>
                                            </td>
                                            <td align="center"><input type="text" style="text-align: center;" value=""></td>
