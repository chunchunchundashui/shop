...
<button type="button" tooltip="添加品牌"  class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('categoryWords/add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center">推荐词</th>
                                <th class="text-center">推荐词顶级栏目</th>
                                <th>推荐词地址</th>
                        ...
                        <?php if(is_array($lst) || $lst instanceof \think\Collection || $lst instanceof \think\Paginator): $i = 0; $__LIST__ = $lst;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                             <tr>
                                <td align="center"><?php echo $vo['id']; ?></td>
                                 <td align="center"><?php echo $vo['word']; ?></td>
                                 <td align="center"><?php echo $vo['cate_name']; ?></td>
                                <td><a href="<?php echo $vo['link_url']; ?>" target="_blank"><?php echo $vo['link_url']; ?></a></td>
                                <td align="center">
                                    <a href="<?php echo url('admin/categoryWords/edit', ['id' => $vo['id']]); ?>" class="btn btn-primary btn-sm shiny">编辑</a>
    ...
    <script>
      function del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
          ...
          //发异步删除数据
          $.post("<?php echo url('CategoryWords/del'); ?>",{id:id},function (data) {
            if(data.code == 1){
              div.remove();
              //删除成功 删除元素
