<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"D:\phpStudy\WWW\shop\public/../application/admin\view\link\edit.htm";i:1574320167;s:58:"D:\phpStudy\WWW\shop\application\admin\view\common\top.htm";i:1572317047;s:59:"D:\phpStudy\WWW\shop\application\admin\view\common\left.htm";i:1574384184;s:57:"D:\phpStudy\WWW\shop\application\admin\view\common\js.htm";i:1572488612;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action=""  method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="title" placeholder="" value="<?php echo $linkInfo['title']; ?>" name="title" required="" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="link_url" class="col-sm-2 control-label no-padding-right">链接官网</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="link_url" placeholder="" value="<?php echo $linkInfo['link_url']; ?>" name="link_url"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="logo" class="col-sm-2 control-label no-padding-right">链接logo</label>
                                            <div class="col-sm-6">
                                                <input  placeholder="" id="logo" name="logo"  type="file">
                                                <?php if($linkInfo['logo'] != ''): ?>
                                                <img src="/shop/public/static/uploads/<?php echo $linkInfo['logo']; ?>" height="600">
                                                <?php else: ?>
                                                暂无图片
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label for="description" class="col-sm-2 control-label no-padding-right">链接描述</label>
                                            <div class="col-sm-6">
                                                <textarea name="description" style="width: 100%;" id="description" cols="30" rows="10" class=""><?php echo $linkInfo['description']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="status" class="col-sm-2 control-label no-padding-right">链接状态</label>
                                            <div class="col-sm-6">
                                                <div class="radio" style="float:left; padding-right: 10px;">
                                                    <label>
                                                        <input type="radio" id="status" name="status" <?php if($linkInfo['status'] == 1): ?> checked="checked" <?php endif; ?> value="1" class="colored-blue">
                                                        <span class="text">显示</span>
                                                    </label>
                                                </div>
                                                <div class="radio" style="float:left;">
                                                    <label>
                                                        <input type="radio" name="status" value="0" <?php if($linkInfo['status'] == 0): ?> checked="checked" <?php endif; ?> class="colored-blue">
                                        ...
                                        <div class="form-group">
                                            <label for="status" class="col-sm-2 control-label no-padding-right">链接类型</label>
                                            <div class="col-sm-6">
                                                <div class="radio" style="float:left; padding-right: 10px;">
                                                    <label>
                                                        <input type="radio" id="type" name="type" <?php if($linkInfo['type'] == 1): ?> checked="checked" <?php endif; ?> value="1" class="colored-blue">
                                                        <span class="text">文字</span>
                                                    </label>
                                                </div>
                                                <div class="radio" style="float:left;">
                                                    <label>
                                                        <input type="radio" name="type" value="2" <?php if($linkInfo['type'] == 2): ?> checked="checked" <?php endif; ?> class="colored-blue">
                                        ...
                                        <!--<div class="form-group">-->
                                        <!--<label for="group_id" class="col-sm-2 control-label no-padding-right">链接角色</label>-->
                                        <!--<div class="col-sm-6">-->
