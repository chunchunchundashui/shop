                                    ...
                                    <form class="form-horizontal" role="form" action="" method="post"
                                        ...
                                        <div class="form-group">
                                            <label for="brand_name"
                                                   class="col-sm-2 control-label no-padding-right">商品类型名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="brand_name" placeholder=""
                                                       value="<?php echo $TypeInfo['type_name']; ?>" name="type_name" required=""
                                                       type="text">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" id="brandEdit" class="btn Type_edit btn-default">保存信息
                                                </button>
                                            </div>
                                        </div>
                                    </form>
