<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"D:\phpStudy\WWW\shop/application/member\view\account\reg.htm";i:1595227836;}*/ ?>
...
<head>
  ...
  <script type="text/javascript" src="/shop/public/static/index/js/jquery.json.js"></script><script type="text/javascript" src="/shop/public/static/index/js/transport_jquery.js"></script>
  <style>
    .sms-btn {
      background: none;
...
<div class="register">
  <div class="loginRegister-header">
    <div class="w w1200">
      <div class="logo">
        <div class="logoImg"><a href="./index.php" class="logo"><img src="/shop/public/static/index/img/user_login_logo.png" /></a></div>
        <div class="logo-span">
          <b style="background:url(__index/img/login_logo_pic.png) no-repeat;"></b>                </div>
      </div>
    ...
    <div class="w w1200">
      <div class="register-wrap">
        <div class="register-adv">
          <a href="affiche.php?ad_id=456&amp;uri=https%3A%2F%2Fwww.dscmall.cn%2F" target="_blank"><img width="400" height="324" src="/shop/public/static/index/img/1488939821671881226.jpg" /></a>
        </div>
            ...
            <form action="" method="post" name="formUser">
              ...
              <div class="item" id="code_mobile">
                ...
                <div class="item-info">
                  ...
                  <!--<a href="javascript:sendChangePhone();" onclick="invokeSettime(this)" id="zphone" class="sms-btn">获取验证码</a>-->
                  <input type="button" onclick="sendChangePhone();" value="获取验证码" id="zphone" class="sms-btn">
                </div>
                <div class="input-tip"></div>
              </div>
...
<script type="text/javascript" src="/shop/public/static/index/js/scroll_city.js"></script><script type="text/javascript" src="/shop/public/static/index/js/user.js"></script><script type="text/javascript" src="/shop/public/static/index/js/user_register.js"></script><script type="text/javascript" src="/shop/public/static/index/js/utils.js"></script><script type="text/javascript" src="/shop/public/static/index/js/jquery.SuperSlide.2.1.1.js"></script><script type="text/javascript" src="/shop/public/static/index/js/sms.js"></script><script type="text/javascript" src="/shop/public/static/index/js/perfect-scrollbar.min.js"></script><script type="text/javascript" src="/shop/public/static/index/js/jquery.validation.min.js"></script><script type="text/javascript" src="/shop/public/static/index/js/dsc-common.js"></script>
...
<script type="text/javascript">
  ...
  $(function () {
    $('#registsubmit').click(function () {
      $.ajax({
        url:"<?php echo url('member/account/reg'); ?>",
        type:'post',
        data:$('form').serialize(),
        dataType:'json',
        success:function (data) {
          if (data.code == 1) {
            ...
            layer.msg(data.msg, {content: data.msg,icon: 5,time: 2000});
          }
        }
      });
    });
