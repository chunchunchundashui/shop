        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加商品类型" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href = '<?php echo url('Type/add'); ?>'"><i class="fa fa-plus"></i> Add
                </button>
                <div class="row">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="<?php echo url('attr/lst', ['type_id' => $vo['id']]); ?>"
                                                   class="fa fa-list btn btn-darkorange btn-sm shiny"> 属性列表</a>
                                                <a href="<?php echo url('type/edit', ['id' => $vo['id']]); ?>"
