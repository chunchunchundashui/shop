        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('categoryBrands/lst'); ?>">品牌管理</a>
                    </li>
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action=""  method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="brands_id" class="col-sm-2 control-label no-padding-right">关联品牌名称</label>
                                            <div class="col-sm-6">
                                                <div class="checkbox">
                                                    <?php
                                                        $arr = explode(',', $CategoryBrands['brands_id']);
                                                    if(is_array($brands) || $brands instanceof \think\Collection || $brands instanceof \think\Paginator): $i = 0; $__LIST__ = $brands;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$brand): $mod = ($i % 2 );++$i;
                                        ...
                                        <div class="form-group">
                                            <label for="pro_img" class="col-sm-2 control-label no-padding-right">推广图</label>
                                            <div class="col-sm-6">
                                                <input  placeholder="" id="pro_img" name="pro_img"  type="file">
                                                <?php if($CategoryBrands['pro_img']): ?>
                                                <img src="/shop/public/static/pro_img/<?php echo $CategoryBrands['pro_img']; ?>">
                                                <?php else: ?>
                                                无缩略图
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label for="pro_url" class="col-sm-2 control-label no-padding-right">推广地址</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="pro_url" placeholder="" name="pro_url" value="<?php echo $CategoryBrands['pro_url']; ?>" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
