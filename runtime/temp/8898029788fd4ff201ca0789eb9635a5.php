                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action=""  method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="id" value="<?php echo $articleLst['id']; ?>">
                                        <div class="form-group">
                                            <label for="brand_name" class="col-sm-2 control-label no-padding-right">所属栏目</label>
                                            <div class="col-sm-6">
                                                <select class="form-control" name="cate_id">
                                                    <option value="">选择栏目</option>
                                                    <?php if(is_array($cate) || $cate instanceof \think\Collection || $cate instanceof \think\Paginator): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                    <option <?php if($articleLst['cate_id'] == $vo['id']): ?> selected="selected" <?php endif; if(in_array(($vo['id']), explode(',',"1,2"))): ?> disabled="disabled" <?php endif; ?> value="<?php echo $vo['id']; ?>"> <?php echo str_repeat('-', $vo['level']*8)?><?php echo $vo['cate_name']; ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="title" placeholder="" value="<?php echo $articleLst['title']; ?>" name="title" required="" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="show_top" class="col-sm-2 control-label no-padding-right">置顶</label>
                                            <div class="col-sm-6">
                                                <div class="radio" style="float:left; padding-right: 10px;">
                                                    <label>
                                                        <input type="radio" id="show_top" name="show_top" <?php if($articleLst['show_top'] == 1): ?> checked="checked" <?php endif; ?> value="1" class="colored-blue">
                                                        <span class="text">是</span>
                                                    </label>
                                                </div>
                                                <div class="radio" style="float:left;">
                                                    <label>
                                                        <input type="radio" name="show_top" value="0" <?php if($articleLst['show_top'] == 0): ?> checked="checked" <?php endif; ?> class="colored-blue">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea name="keywords" style="width: 100%;" id="keywords" cols="30" rows="10" class=""><?php echo $articleLst['keywords']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="description" class="col-sm-2 control-label no-padding-right">描述</label>
                                            <div class="col-sm-6">
                                                <textarea name="description" style="width: 100%;" id="description" cols="30" rows="10" class=""><?php echo $articleLst['description']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="author" class="col-sm-2 control-label no-padding-right">作者</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="author" placeholder="" value="<?php echo $articleLst['author']; ?>" name="author"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="email" class="col-sm-2 control-label no-padding-right">邮箱</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="email" placeholder="" value="<?php echo $articleLst['email']; ?>" name="email"  type="email">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="link_url" class="col-sm-2 control-label no-padding-right">外链</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="link_url" placeholder="" value="<?php echo $articleLst['link_url']; ?>" name="link_url"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="thumb" class="col-sm-2 control-label no-padding-right">缩略图</label>
                                            <div class="col-sm-6">
                                                <input  placeholder="" id="thumb" name="thumb"  type="file">
                                                <?php if($articleLst['thumb'] != ''): ?>
                                                    <img src="/shop/public/static/uploads/<?php echo $articleLst['thumb']; ?>" height="600" width="860" alt="">
                                                <?php else: ?>
                                                    暂无图片
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label for="article_content" class="col-sm-2 control-label no-padding-right">文章内容</label>
                                            <div class="col-sm-6">
                                                <textarea name="content" id="article_content" cols="30" rows="10" class=""><?php echo $articleLst['content']; ?></textarea>
                                            </div>
                                        </div>

                                        <!--<div class="form-group">-->
                                        <!--<label for="group_id" class="col-sm-2 control-label no-padding-right">文章角色</label>-->
                                        <!--<div class="col-sm-6">-->
...
<script>
    $(function () {
        UE.getEditor('article_content',{initialFrameHeight:300,});
