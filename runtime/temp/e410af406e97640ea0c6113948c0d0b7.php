    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加会员级别" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href = '<?php echo url('MemberLevel/add'); ?>'"><i class="fa fa-plus"></i> Add
                </button>
                <div class="row">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $vo['bom_point']; ?></td>
                                            <td><?php echo $vo['top_point']; ?></td>
                                            <td><?php echo $vo['rate']; ?></td>
                                            <td align="center">
                                                <a href="<?php echo url('MemberLevel/edit', ['id' => $vo['id']]); ?>"
    ...
    $(function () {
        $('.Type_del').click(function () {
            ...
            layer.confirm('确定要删除吗?', {
                ...
                layer.close(index);
                $.ajax({
                    url: "<?php echo url('MemberLevel/del'); ?>",
                    type: 'post',
                    data: {id: id},
                    dataType: 'json',
