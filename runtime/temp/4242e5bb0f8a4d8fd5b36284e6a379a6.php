    ...
    <!-- /Sidebar Menu -->
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加推荐位" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href = '<?php echo url('Recpos/add'); ?>'"><i class="fa fa-plus"></i> Add
                </button>
                <div class="row">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $vo['rec_name']; ?></td>
                                            <td><?php if($vo['rec_type'] == 1): ?>商品推荐位<?php else: ?>分类推荐位<?php endif; ?></td>
                                            <td align="center">
                                                <a href="<?php echo url('admin/Recpos/edit', ['id' => $vo['id']]); ?>"
                                                ...
                                                <a href="javascript:;" class="fa fa-trash-o btn btn-danger Type_del btn-sm shiny"
                                                   onclick="del(this,'<?php echo $vo['id']; ?>')"> 删除</a>
                                            </td>
                                        </tr>
...
<script>
  function del(obj,id){
    layer.confirm('确认要删除吗？',function(index){
      ...
      //发异步删除数据
      $.post("<?php echo url('Recpos/del'); ?>",{id:id},function (data) {
        if(data.code == 1){
          div.remove();
          //删除成功 删除元素
