                            ...
                            <div class="widget-body">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        <thead class="">
                                        <tr>
                                            <?php if(is_array($radioAttrRes) || $radioAttrRes instanceof \think\Collection || $radioAttrRes instanceof \think\Paginator): $i = 0; $__LIST__ = $radioAttrRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        ...
                                        <tbody>
                                        <!-- 判断库存是否有值  -->
                                        <?php if(!empty($goodsProRes)): if(is_array($goodsProRes) || $goodsProRes instanceof \think\Collection || $goodsProRes instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsProRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;
                                            $keys = $key;
                                        ?>
                                            <tr>
                                                <?php if(is_array($radioAttrRes) || $radioAttrRes instanceof \think\Collection || $radioAttrRes instanceof \think\Paginator): $i = 0; $__LIST__ = $radioAttrRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                <td align="center">
                                                    <select name="goods_attr[<?php echo $key; ?>][]">
                                                        ...
                                                        ?>
                                                        <option <?php if(in_array($vo1['id'], $arr)): ?> selected="selected" <?php else: endif; ?>  value="<?php echo $vo1['id']; ?>"><?php echo $vo1['attr_value']; ?></option>
                                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </td>
                                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                                <td align="center">
                                                    <input name="goods_num[]" type="text" style="text-align: center;" value="<?php echo $vo2['goods_number']; ?>"></td>
                                                <td align="center"><a onclick="addtr(this);" class="btn btn-sm btn-azure btn-addon" href="javascript:;"><?php if($keys == 0): ?>+<?php else: ?>-<?php endif; ?></a></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <select name="goods_attr[<?php echo $key; ?>][]">
                                                        <option value="">请选择</option>
                                                        <?php if(is_array($vo) || $vo instanceof \think\Collection || $vo instanceof \think\Paginator): $i = 0; $__LIST__ = $vo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?>
                                                        <option value="<?php echo $vo1['id']; ?>"><?php echo $vo1['attr_value']; ?></option>
                                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </td>
                                                <?php endforeach; endif; else: echo "" ;endif; ?>
