                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action=""  method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="id" value="<?php echo $alternate_imgInfo['id']; ?>">
                                        <div class="form-group">
                                            <label for="title" class="col-sm-2 control-label no-padding-right">轮播图名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="title" placeholder="" name="title" value="<?php echo $alternate_imgInfo['title']; ?>" required="" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="link_url" class="col-sm-2 control-label no-padding-right">轮播图地址</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="link_url" placeholder="" value="<?php echo $alternate_imgInfo['link_url']; ?>" name="link_url"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="img_src" class="col-sm-2 control-label no-padding-right">轮播图</label>
                                            <div class="col-sm-6">
                                                <input  placeholder="" id="img_src" name="img_src" type="file">
                                                <?php if($alternate_imgInfo['img_src']): ?>
                                                <img src="/shop/public/static/uploads/<?php echo $alternate_imgInfo['img_src']; ?>" alt="" width="600" height="300">
                                                <?php else: ?>
                                                无缩略图
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label for="status" class="col-sm-2 control-label no-padding-right">轮播图状态</label>
                                            <div class="col-sm-6">
                                                <div class="radio" style="float:left; padding-right: 10px;">
                                                    <label>
                                                        <input type="radio" id="status" name="status" <?php if($alternate_imgInfo['status'] == 1): ?> checked="checked" <?php endif; ?> value="1" class="colored-blue">
                                                        <span class="text">显示</span>
                                                    </label>
                                                </div>
                                                <div class="radio" style="float:left;">
                                                    <label>
                                                        <input type="radio" name="status" <?php if($alternate_imgInfo['status'] == 0): ?> checked="checked" <?php endif; ?> value="0" class="colored-blue">
                                        ...
                                        <!--<div class="form-group">-->
                                        <!--<label for="group_id" class="col-sm-2 control-label no-padding-right">轮播图角色</label>-->
                                        <!--<div class="col-sm-6">-->
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" id="alternate_imgAdd" class="btn alternate_img_Add btn-default">保存信息</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
<script>
  $(function () {
    UE.getEditor('alternate_img_description');
  ...
  //         if (e.keyCode === 13) {
  //             $("#alternate_img_Add").trigger("click");
  //         }
  //     });
  // };
