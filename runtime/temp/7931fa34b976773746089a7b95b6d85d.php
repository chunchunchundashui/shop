<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"D:\phpStudy\WWW\shop/application/member\view\account\login.htm";i:1594653259;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="w w1200">
    ...
    <div class="tit"><h3>用第三方账号直接登录</h3><span></span></div>
        ...
        <a href="<?php echo url('member/account/QqLogin'); ?>" class="qq"><b class="third-party-icon qq-icon"></b></a>
        </div>
</div>
        <div class="login-box">
...
<div class="login-banner" style="background:url(/shop/public/static/index/img/1488936109167439630.jpg) center center no-repeat;">
    <div class="w w1200">
