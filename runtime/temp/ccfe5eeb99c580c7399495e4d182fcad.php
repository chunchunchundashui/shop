<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:56:"D:\phpStudy\WWW\shop/application/admin\view\nav\edit.htm";i:1592229762;s:58:"D:\phpStudy\WWW\shop\application\admin\view\common\top.htm";i:1593441386;s:59:"D:\phpStudy\WWW\shop\application\admin\view\common\left.htm";i:1593325978;s:57:"D:\phpStudy\WWW\shop\application\admin\view\common\js.htm";i:1572488612;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                ...
                <div class="navbar-account">
                    <ul class="account-area">
                        <li><a href="<?php echo url('Index/clearCache'); ?>" class="login-area dropdown-toggle">
                            <section>
                                <h2><span class="profile"><span>清空缓存</span></span></h2>
                            </section>
                        </a></li>
                        <li>
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action=""  method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="nav_name" placeholder="" name="nav_name" value="<?php echo $navInfo['nav_name']; ?>" required="" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="nav_url" class="col-sm-2 control-label no-padding-right">导航地址</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="nav_url" placeholder="" name="nav_url"  value="<?php echo $navInfo['nav_url']; ?>" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="pos" class="col-sm-2 control-label no-padding-right">导航位置</label>
                                            <div class="col-sm-6">
                                                <select class="form-control" name="pos">
                                                    <option value="">请选择</option>
                                                    <option <?php if($navInfo['pos'] == 'top'): ?> selected="selected" <?php endif; ?> value="top">顶部</option>
                                                    <option <?php if($navInfo['pos'] == 'mid'): ?> selected="selected" <?php endif; ?> value="mid">中间</option>
                                                    <option <?php if($navInfo['pos'] == 'bottom'): ?> selected="selected" <?php endif; ?> value="bottom">底部</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="open" class="col-sm-2 control-label no-padding-right">导航状态</label>
                                            <div class="col-sm-6">
                                                <div class="radio" style="float:left; padding-right: 10px;">
                                                    <label>
                                                        <input type="radio" id="open" <?php if($navInfo['open'] == 1): ?> checked="checked" <?php endif; ?> name="open" value="1" class="colored-blue">
                                                        <span class="text">显示</span>
                                                    </label>
                                                </div>
                                                <div class="radio" style="float:left;">
                                                    <label>
                                                        <input type="radio" name="open" <?php if($navInfo['open'] == 2): ?> checked="checked" <?php endif; ?> value="2" class="colored-blue">
                                        ...
                                        <!--<div class="form-group">-->
                                        <!--<label for="group_id" class="col-sm-2 control-label no-padding-right">导航角色</label>-->
                                        <!--<div class="col-sm-6">-->
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" id="navAdd" class="btn nav_Add btn-default">保存信息</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
