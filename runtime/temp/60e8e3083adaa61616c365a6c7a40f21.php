...
<!--<button type="button" tooltip="添加订单"  class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('brand/add'); ?>'"> <i class="fa fa-plus"></i> Add-->
<!--</button>-->
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($orderGoods) || $orderGoods instanceof \think\Collection || $orderGoods instanceof \think\Paginator): $i = 0; $__LIST__ = $orderGoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                             <tr>
                                ...
                                <td align="center"><?php echo cut_str($vo['goods_name'],13); ?></td>
                                <td align="center"><?php echo $vo['member_price']; ?></td>
                                <td align="center"><?php echo $vo['shop_price']; ?></td>
                                <td align="center"><?php echo $vo['market_price']; ?></td>
                                <td align="center"><?php echo $vo['goods_attr_str']; ?></td>
                                <td align="center"><?php echo $vo['goods_num']; ?></td>
                                <td align="center">
                                  <a href="<?php echo url('admin/Order/orderGoodsEdit', array('id' => $vo['id'])); ?>" class="btn btn-primary btn-sm shiny">编辑</a>
    ...
    <script>
      function del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
          ...
          //发异步删除数据
          $.post("<?php echo url('admin/Order/orderGoodsDel'); ?>",{id:id},function (data) {
            if(data.code == 1){
              div.remove();
              //删除成功 删除元素
