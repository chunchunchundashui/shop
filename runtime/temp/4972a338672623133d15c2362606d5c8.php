                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action=""  method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="brand_name" class="col-sm-2 control-label no-padding-right">所属类型</label>
                                            <div class="col-sm-6">
                                                <select name="type_id" style="width: 100%;">
                                                    <option value="">请选择</option>
                                                    <?php if(is_array($attrType) || $attrType instanceof \think\Collection || $attrType instanceof \think\Paginator): $i = 0; $__LIST__ = $attrType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                    <option <?php if($attrInfo['type_id'] == $vo['id']): ?> selected="selected"<?php endif; ?> value="<?php echo $vo['id']; ?>"><?php echo $vo['type_name']; ?></option>
                                        ...
                                        <div class="form-group">
                                            <label for="brand_name" class="col-sm-2 control-label no-padding-right">商品属性名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" value="<?php echo $attrInfo['attr_name']; ?>" name="attr_name" required="" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="brand_name" class="col-sm-2 control-label no-padding-right">商品属性类型</label>
                                            <div class="col-sm-6">
                                                <div class="radio" style="float:left; padding-right: 10px;">
                                                    <label>
                                                        <input <?php if($attrInfo['attr_type'] == 1): ?>  checked="checked" <?php endif; ?> type="radio" name="attr_type" value="1"  class="colored-blue">
                                                        <span class="text">单选</span>
                                                    </label>
                                                </div>
                                                <div class="radio" style="float:left;">
                                                    <label>
                                                        <input type="radio" <?php if($attrInfo['attr_type'] == 2): ?>  checked="checked" <?php endif; ?> name="attr_type" value="2" class="colored-blue">
                                        ...
                                        <div class="form-group">
                                            <label for="brand_name" class="col-sm-2 control-label no-padding-right">商品属性值列表</label>
                                            <div class="col-sm-6">
                                                <textarea class="form-control" name="attr_values" cols="30" rows="10"><?php echo $attrInfo['attr_values']; ?></textarea>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
