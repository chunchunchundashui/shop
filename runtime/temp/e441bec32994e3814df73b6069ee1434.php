                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action=""  method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="brand_url" placeholder="" name="brand_url"  type="text">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea name="brand_description" id="brand_description" cols="30" rows="10" class=""></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio" style="float:left; padding-right: 10px;">
                                    <label>
                                        <input type="radio" id="status" name="status" value="1" class="colored-blue">
