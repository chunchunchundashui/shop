                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('index/index'); ?>">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('admin/Order/orderGoods',array('id' => $orderGoodsInfo['order_id'])); ?>">商品管理</a>
                    </li>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action=""  method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="brand_name" class="col-sm-2 control-label no-padding-right">商品名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="goods_name" value="<?php echo $orderGoodsInfo['goods_name']; ?>" required="" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="brand_name" class="col-sm-2 control-label no-padding-right">会员价</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="member_price" value="<?php echo $orderGoodsInfo['member_price']; ?>" required="" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="brand_name" class="col-sm-2 control-label no-padding-right">本店价</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="shop_price" value="<?php echo $orderGoodsInfo['shop_price']; ?>" required="" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="brand_name" class="col-sm-2 control-label no-padding-right">市场价</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="market_price" value="<?php echo $orderGoodsInfo['market_price']; ?>" required="" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="brand_name" class="col-sm-2 control-label no-padding-right">商品属性</label>
                            <div class="col-sm-6">
                                <textarea name="goods_attr_str" cols="110" rows="10"><?php echo $orderGoodsInfo['goods_attr_str']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="brand_name" class="col-sm-2 control-label no-padding-right">商品数量</label>
                            <div class="col-sm-6">
                                <input class="form-control" placeholder="" name="goods_num" value="<?php echo $orderGoodsInfo['goods_num']; ?>" required="" type="text">
                            </div>
                        </div>
                        <div class="form-group">
