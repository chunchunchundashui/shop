                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('order/lst'); ?>"  method="post">
                        <div class="form-group">
                            <div class="col-sm-6">
                                <select name="select_base" id="" style="float: left">
                                    <option value="order_trade_no">订单号</option>
                                    <option value="username">用户名</option>
                                </select>
                                <input class="form-control" id="brand_name" style="width: 400px; float: left;" placeholder="" name="select_value" required="" type="text">
                                <button type="submit" style="width: 100px; margin-left: 10px;" id="brandAdd" class="btn brand_Add form-control btn-default">保存信息</button>
                            </div>
                        </div>
                    </form>
                </div>
