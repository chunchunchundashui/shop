                                            ...
                                            <div class="tab-content tabs-flat">
                                                ...
                                                <div id="goodsAttr" class="tab-pane">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <select name="type_id" class="form-control" disabled="disabled">
                                                                <option value="">请选择</option>
                                                ...
                                                <div id="goodsphoto" class="tab-pane">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="cname"
                                                               class="col-sm-2 control-label no-padding-right"></label>
                                                        <div class="col-sm-6">
                                                            <a href="#" onclick="addrow(this);">[+]</a><input class="form-control" id="cname" style="border:none; box-shadow: none; display: inline-block;width: 50%" name="goods_photo[]" type="file">
                                                        </div>
                                                    </div>
