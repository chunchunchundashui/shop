<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"D:\phpStudy\WWW\shop\public/../application/admin\view\member_level\edit.htm";i:1574340686;s:58:"D:\phpStudy\WWW\shop\application\admin\view\common\top.htm";i:1572317047;s:59:"D:\phpStudy\WWW\shop\application\admin\view\common\left.htm";i:1574340737;s:57:"D:\phpStudy\WWW\shop\application\admin\view\common\js.htm";i:1572488612;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action=""  method="post">
                                        <input type="hidden" name="id" value="<?php echo $memberL['id']; ?>">
                                        <div class="form-group">
                                            <label for="brand_name" class="col-sm-2 control-label no-padding-right">会员级别名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" name="level_name" value="<?php echo $memberL['level_name']; ?>" required="" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="brand_name" class="col-sm-2 control-label no-padding-right">级别积分下限</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" value="<?php echo $memberL['bom_point']; ?>" name="bom_point" required="" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="brand_name" class="col-sm-2 control-label no-padding-right">级别积分上限</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" value="<?php echo $memberL['top_point']; ?>" name="top_point" required="" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="brand_name" class="col-sm-2 control-label no-padding-right">级别折扣率</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" value="<?php echo $memberL['rate']; ?>" name="rate" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
...
<script>
    $(function () {
        $('.Type_edit').click(function () {
            $.ajax({
                url:"<?php echo url('MemberLevel/edit'); ?>",
                type:'post',
                data:$('form').serialize(),
                dataType:'json',
