    ...
    <ul class="nav sidebar-menu">
        ...
        <li>
            ...
            <ul class="submenu">
                ...
                <li>
                    <a href="<?php echo url('admin/CategoryWords/add'); ?>">
