<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:55:"D:\phpStudy\WWW\shop/application/admin\view\nav\lst.htm";i:1592310890;s:58:"D:\phpStudy\WWW\shop\application\admin\view\common\top.htm";i:1593441874;s:59:"D:\phpStudy\WWW\shop\application\admin\view\common\left.htm";i:1593325978;s:57:"D:\phpStudy\WWW\shop\application\admin\view\common\js.htm";i:1572488612;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($lst) || $lst instanceof \think\Collection || $lst instanceof \think\Paginator): $i = 0; $__LIST__ = $lst;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                             <tr>
                                ...
                                <td><a href="<?php echo $vo['nav_url']; ?>" target="_blank"><?php echo $vo['nav_url']; ?></a></td>
                                <td align="center"><?php if($vo['pos'] == 'top'): ?> 顶部 <?php elseif($vo['pos'] == 'mid'): ?> 中间 <?php else: ?> 底部 <?php endif; ?></td>
                                <td align="center">
                                    <?php if($vo['open'] == 1): ?>
                                      是
                                    <?php else: ?>
                                ...
                                <td align="center">
                                    <a href="<?php echo url('admin/nav/edit', ['id' => $vo['id']]); ?>" class="btn btn-primary btn-sm shiny">编辑</a>
                                  <!--dataid="<?php echo $vo['id']; ?>"-->
                                    <a href="javascript:;" onclick="del(this,'<?php echo $vo['id']; ?>')" class="btn btn-danger nav_del btn-sm shiny" >删除</a>
                                </td>
                            </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                        <tr>
                          <td colspan="7" style="padding-left: 10.5%;"><input type="submit" class="btn btn-sm btn-azure btn-addon" value="排序"></td>
                        </tr>
                        </tbody>
                    </table>
                  </form>
    ...
    <script>
      function del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
          ...
          //发异步删除数据
          $.post("<?php echo url('nav/del'); ?>",{id:id},function (data) {
            if(data.code == 1){
              div.remove();
              //删除成功 删除元素
