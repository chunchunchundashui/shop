                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($lst) || $lst instanceof \think\Collection || $lst instanceof \think\Paginator): $i = 0; $__LIST__ = $lst;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                             <tr>
                                ...
                                <td><a href="<?php echo $vo['brand_url']; ?>" target="_blank"><?php echo $vo['brand_url']; ?></a></td>
                                <td align="center">
                                    <?php if($vo['brand_img'] != ''): ?>
                                    <img src="/shop/public/static/uploads/<?php echo $vo['brand_img']; ?>" height="30px" alt="">
                                    <?php else: ?>
                                    暂无图片
                                    <?php endif; ?>
                                </td>
                                <td align="center"><?php echo cut_str($vo['brand_description'],10); ?></td>
                                <td align="center">
                                    <?php if($vo['status'] == 1): ?>
                                ...
                                <td align="center">
                                    <a href="<?php echo url('admin/brand/edit', ['id' => $vo['id']]); ?>" class="btn btn-primary btn-sm shiny">编辑</a>
        ...
        $(function () {
           $('.brand_del').click(function () {
               ...
               layer.confirm('确定要删除吗?', {
                   ...
                   layer.close(index);
                   $.ajax({
                       url:"<?php echo url('admin/Brand/del'); ?>",
                       type:'post',
                       data:{id:id},
                       dataType:'json',
