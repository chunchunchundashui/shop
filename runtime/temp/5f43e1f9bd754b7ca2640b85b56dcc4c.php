...
<head>
  ...
  </script><link rel="stylesheet" type="text/css" href="/shop/public/static/index/css/perfect-scrollbar.min.css" />
</head>
<script>
  //  这个地址是在login.js下面
        ...
        <div class="cart-tbody" ectype="cartTboy">
          ...
          <div class="cart-item" ectype="shopItem">
            ...
            <div class="item-list" ectype="itemList">
              <!-- 循环 -->
              <?php if(is_array($cartGoodsRes) || $cartGoodsRes instanceof \think\Collection || $cartGoodsRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cartGoodsRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cartGoods): $mod = ($i % 2 );++$i;?>
                  ...
                  <div class="item-form">
                    <div class="cell s-checkbox">
                      <div class="cart-checkbox" ectype="ckList">
                        <input type="checkbox" id="checkItem_<?php echo $cartGoods['goods_id_attr_id']; ?>" value="<?php echo $cartGoods['goods_id_attr_id']; ?>" name="checkItem" class="ui-checkbox" ectype="ckGoods">
                        <label for="checkItem_<?php echo $cartGoods['goods_id_attr_id']; ?>" class="ui-label-14">&nbsp;</label>
                      </div>
                    </div>
                    <div class="cell s-goods">
                      <div class="goods-item">
                        <div class="p-img">
                          <a href="#" target="_blank"><img src="/shop/public/static/uploads/<?php echo $cartGoods['sm_thumb']; ?>" width="70" height="70"></a>
                        </div>
                        <div class="item-msg">
                          <a href="#" target="_blank"><?php echo $cartGoods['goods_name']; ?></a>
                          <div class="gds-types">
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="cell s-props">
                      <?php echo $cartGoods['goods_attr_str']; ?>
                    </div>
                    <div class="cell s-price">
                      <strong id="goods_price_8"><em>¥</em><?php echo $cartGoods['member_price']; ?></strong>
                    </div>
                    <div class="cell s-quantity">
                      <div class="amount-warp">
                        <input type="text" value="<?php echo $cartGoods['goods_num']; ?>" name="goods_number[8]" id="goods_number_8" onchange="change_goods_number('<?php echo $cartGoods['goods_id_attr_id']; ?>', this.value, 2, 16)" class="text buy-num" ectype="number" defaultnumber="1">
                        <div class="a-btn">
                          <a href="#" onclick="changenum('<?php echo $cartGoods['goods_id_attr_id']; ?>', 1, 2, 16, 17, this)" class="btn-add"><i class="iconfont icon-up"></i></a>
                          <a href="#" onclick="changenum('<?php echo $cartGoods['goods_id_attr_id']; ?>', -1, 2, 16, 17, this)" <?php if($cartGoods['goods_num'] == 1): ?> class="btn-reduce btn-disabled" <?php else: ?> class="btn-reduce" <?php endif; ?>><i class="iconfont icon-down"></i></a>
                        </div>
                      </div>
                      <div class="tc ftx-03">有货</div>
                    </div>
                    <div class="cell s-sum">
                      <strong id="goods_subtotal_8"><font id="_8_subtotal"><em>¥</em><?php echo $cartGoods['subtotal']; ?></font></strong>
                    ...
                    <div class="cell s-action">
                      <a href="#" id="remove_8" ectype="cartOperation" data-value="{&quot;divId&quot;:&quot;cart_remove&quot;,&quot;url&quot;:&quot;<?php echo url('Flow/dropGoods', array('id_attr' => $cartGoods['goods_id_attr_id']), ''); ?>&quot;,&quot;cancelUrl&quot;:&quot;flow.php?step=drop_to_collect&amp;id=8&quot;,&quot;recid&quot;:8,&quot;title&quot;:&quot;删除&quot;}" class="cart-remove">删除</a>
        ...
        <div class="cart-tfoot">
          <div class="cart-toolbar">
            <div class="w w1200">
              ...
              <div class="operation">
                <a href="#" class="cart-remove-batch" data-dialog="remove_collect_dialog" data-divid="cart-remove-batch" data-removeurl="<?php echo url('Flow/delCartGoods'); ?>" data-collecturl="ajax_dialog.php?act=drop_to_collect" data-title="删除">删除选中的商品</a>
...
<script type="text/javascript" src="/shop/public/static/index/js/checkAll.js"></script>
<script type="text/javascript">
