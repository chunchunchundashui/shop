                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action=""  method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="iconfont" placeholder="" name="iconfont" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="checkbox">
                                    <?php if(is_array($categoryRecpos) || $categoryRecpos instanceof \think\Collection || $categoryRecpos instanceof \think\Paginator): $i = 0; $__LIST__ = $categoryRecpos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$category): $mod = ($i % 2 );++$i;?>
                                    <label style="margin-right: 15px;">
                                        <input type="checkbox" value="<?php echo $category['id']; ?>" name="recpos[]" class="colored-blue">
                                        <span class="text"><?php echo $category['rec_name']; ?></span>
                                    </label>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="radio" style="float:left;">
                                    <label>
                                        <input type="radio" name="show_cate" value="0" checked="checked" class="colored-blue">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea style="width: 100%;resize: none" name="keywords" cols="30" rows="10" class=""></textarea>
                            </div>
                        </div>
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <!--resize: none  禁止填写框拉动-->
                                <textarea name="description" style="width: 100%;resize: none" cols="30" rows="10" class=""></textarea>
                            </div>
                        </div>
                        <!--<div class="form-group">-->
...
<script src="/shop/public/static/lib/layer/layer.js"></script>
    ...
    <script>
        ...
        //     $(jquery-3.3.1.min.js).keydown(function (e) {
        //         if (e.keyCode === 13) {
