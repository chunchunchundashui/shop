            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if(is_array($cateLst) || $cateLst instanceof \think\Collection || $cateLst instanceof \think\Paginator): $i = 0; $__LIST__ = $cateLst;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                             <tr>
                                ...
                                <td align="center">
                                    <a href="<?php echo url('Cate/edit', array('id'=>$vo['id'])); ?>" class="btn btn-primary btn-sm shiny">编辑</a>
    ...
    <script>
           ...
           $('.brand_del').click(function () {
               ...
               layer.confirm('确定要删除吗?', {
                   ...
                   layer.close(index);
                   $.ajax({
                       url:"<?php echo url('admin/Cate/del'); ?>",
                       type:'post',
                       data:{id:id},
                       dataType:'json',
