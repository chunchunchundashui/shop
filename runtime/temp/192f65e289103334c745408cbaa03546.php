        ...
        <div class="page-content">
            ...
            <div class="page-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('categoryWords/lst'); ?>">推荐词管理</a>
                    </li>
                    <li class="active">修改推荐词</li>
                </ul>
            </div>
            <!-- /Page Breadcrumb -->
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">修改推荐词</span>
                            </div>
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action=""  method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="id" value="<?php echo $categoryWordsInfo['id']; ?>">
                                        <div class="form-group">
                                            <label for="brand_name" class="col-sm-2 control-label no-padding-right">推荐词顶级栏目</label>
                                            <div class="col-sm-6">
                                                <select name="category_id" id="">
                                                    <option value="">请选择</option>
                                                    <?php if(is_array($cateRes) || $cateRes instanceof \think\Collection || $cateRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cateRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
                                                    <option <?php if($cate['id'] == $categoryWordsInfo['category_id']): ?> selected="selected" <?php endif; ?> value="<?php echo $cate['id']; ?>"><?php echo $cate['cate_name']; ?></option>
                                        ...
                                        <div class="form-group">
                                            <label for="brand_name" class="col-sm-2 control-label no-padding-right">推荐词</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="brand_name" placeholder="" name="word" value="<?php echo $categoryWordsInfo['word']; ?>" required="" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
                                        <div class="form-group">
                                            <label for="link_url" class="col-sm-2 control-label no-padding-right">推荐词网址</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" id="link_url" placeholder="" name="link_url" value="<?php echo $categoryWordsInfo['link_url']; ?>"  type="text">
                                            </div>
                                        </div>
                                        <!--<div class="form-group">-->
                                        <!--<label for="group_id" class="col-sm-2 control-label no-padding-right">推荐词角色</label>-->
                                        <!--<div class="col-sm-6">-->
