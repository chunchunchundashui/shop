<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"D:\phpStudy\WWW\shop/application/index\view\flow\flow2.htm";i:1598018419;s:61:"D:\phpStudy\WWW\shop\application\index\view\common\footer.htm";i:1592318019;}*/ ?>
<!doctype html>
<html>
<head>
  ...
  <script type="text/javascript">
    var json_languages = {
      ...
      "not_seller_batch_goods_num": "\u8bf7\u52fe\u9009\u4e2d\u5546\u54c1\u5728\u4fee\u6539\u5546\u54c1\u6570\u91cf",
      "payment_is_online": "\u5728\u7ebf\u652f\u4ed8"
    };

    //加载效果
    var load_cart_info = '<img src="/shop/public/static/index/img/loadGoods.gif" class="load" />';
  ...
  <link rel="stylesheet" type="text/css" href="/shop/public/static/index/css/calendar.min.css"/>
</head>
...
<div class="header header-cart">
  <div class="w w1200">
    <div class="logo">
      <div class="logoImg"><a href="index.php"><img src="/shop/public/static/index/img/logo.gif"/></a></div>
  ...
  <form action="<?php echo url('index/Flow/flow3'); ?>" method="post" name="doneTheForm" class="validator" id="theForm">
    <div class="w w1200">
      <div class="checkout-warp">
            ...
            <div class="consignee-warp">
              ...
              <div class="user-form">
                ...
                <div class="form-row">
                  ...
                  <div class="form-value"><input type="text" name="name" value="" class="form-input">
                  ...
                  <div class="form-value">
                    <div class="info">
                      <div>
                        ...
                        <script class="resources library" src="/shop/public/static/index/js/area.js" type="text/javascript"></script>
                      </div>
                    </div>
                    <script type="text/javascript">
                      _init_area();
                ...
                <div class="form-row">
                  ...
                  <div class="form-value"><input type="text" name="adress" value="" class="form-input form-input-long">
                    <div class="form_prompt"></div>
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-label"><span class="red">*</span>电子邮箱：</div>
                  <div class="form-value"><input type="text" name="email" value="" class="form-input">
                    <div class="form_prompt"></div>
                  </div>
                </div>
                <div class="form-row">
                ...
                <div class="form-row">
                  <div class="form-label"><span class="red">&nbsp;&nbsp;</span>最佳送货时间：</div>
              ...
              <div class="user-form">
                ...
                <div class="form-row">
                  <div class="form-label"><span class="red">*</span>收货人：</div>
                  <div class="form-value"><input type="text" name="name" value="<?php echo $uAddress['name']; ?>" class="form-input">
                    <div class="form_prompt"></div>
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-label"><span class="red">*</span>手机号码：</div>
                  <div class="form-value">
                    <input type="text" name="phone" value="<?php echo $uAddress['phone']; ?>" class="form-input">
                    <span class="fl">电话号码：</span>
                    <input type="text" name="tel" value="<?php echo $uAddress['tel']; ?>" class="form-input">
                    <div class="form_prompt"></div>
                  </div>
                </div>
                <div class="form-row">
                  ...
                  <div class="form-value">
                    <div class="info">
                      <div>
                        <select class="form-input" id="province" name="province"></select>  
                        <select class="form-input" id="city" name="city"></select>  
                        <select class="form-input" id="county" name="county"></select>
                        <script class="resources library" src="/shop/public/static/index/js/area.js" type="text/javascript"></script>
                      </div>
                    </div>
                    <script type="text/javascript">
                     _init_area();
                    var province = "<?php echo $uAddress['province']; ?>";
                    var city = "<?php echo $uAddress['city']; ?>";
                    var county = "<?php echo $uAddress['county']; ?>";
                ...
                <div class="form-row">
                  <div class="form-label"><span class="red">*</span>详细地址：</div>
                  <div class="form-value"><input type="text" name="adress" value="<?php echo $uAddress['adress']; ?>" class="form-input form-input-long">
                    <div class="form_prompt"></div>
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-label"><span class="red">*</span>电子邮箱：</div>
                  <div class="form-value"><input type="text" name="email" value="<?php echo $uAddress['email']; ?>" class="form-input">
                    <div class="form_prompt"></div>
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-label"><span class="red">&nbsp;&nbsp;</span>邮政编码：</div>
                  <div class="form-value"><input type="text" name="zipcode" value="<?php echo $uAddress['zipcode']; ?>" class="form-input"></div>
                </div>
                <div class="form-row">
                  <div class="form-label"><span class="red">&nbsp;&nbsp;</span>地址别名：</div>
                  <div class="form-value"><input type="text" name="sign_building" value="<?php echo $uAddress['sign_building']; ?>" class="form-input"></div>
                </div>
                <div class="form-row">
                  <div class="form-label"><span class="red">&nbsp;&nbsp;</span>最佳送货时间：</div>
                  <div class="form-value"><input type="text" name="best_time" value="<?php echo $uAddress['best_time']; ?>" class="form-input"></div>
                </div>
              </div>
              <!-- 收货人信息结束 -->
              <?php endif; ?>
            ...
            <div class="payment-warp">
              <div class="payment-list" ectype="paymentType">
                <div class="p-radio-item payment-item" data-value='{"type":"cod","payid":"16","allow":""}'>
                    <span>
                        <input checked="checked" type="radio" name="payment" value="1"/>支付宝
                    </span>
                  <b></b>
                </div>
                <div class="p-radio-item payment-item" data-value='{"type":"cod","payid":"16","allow":""}'>
          ...
          <div class="ck-step-cont">
            <div class="payment-warp">
              <div class="payment-list" ectype="paymentType">
                <div class="p-radio-item payment-item" data-value='{"type":"cod","payid":"16","allow":""}'>
                    <span>
                        <input type="radio" checked="checked" name="distribution" value="申通"/>申通
                    </span>
                  <b></b>
                </div>
                <div class="p-radio-item payment-item" data-value='{"type":"cod","payid":"16","allow":""}'>
                    <span>
                        <input type="radio" name="distribution" value="顺丰"/>顺丰
                    </span>
                  <b></b>
                </div>
              </div>
        ...
        <div class="ck-step">
          <div class="ck-step-tit">
            <h3>商品信息</h3>
            <a href="<?php echo url('index/Flow/flow1'); ?>" class="extra-r">返回购物车</a>
          </div>
          <div class="ck-step-cont">
                ...
                <div class="ck-goods-item" ectype="shoppingList">
                  <div class="ck-goods-cont">
                    <?php
                      ...
                      $memberPrice = 0;
                      $shopPrice = 0;
                    if(is_array($doGoodsRes) || $doGoodsRes instanceof \think\Collection || $doGoodsRes instanceof \think\Paginator): $i = 0; $__LIST__ = $doGoodsRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$doGoods): $mod = ($i % 2 );++$i;
                    $goodsNum += $doGoods['goods_num'];
                    $memberPrice += $doGoods['member_price']*$doGoods['goods_num'];
                    $shopPrice += $doGoods['shop_price']*$doGoods['goods_num'];
                     ?>
                    <div class="cg-item <?php if($i == count($doGoodsRes)): ?> last <?php endif; ?>">
                      <div class="c-col cg-name">
                        ...
                        <a href="goods.php?id=843" target="_blank">
                          <div class="p-img"><img src="/shop/public/static/uploads/<?php echo $doGoods['sm_thumb']; ?>" width="48"
                                                  height="48"></div>
                          <div class="p-info">
                            <div class="p-name"><?php echo $doGoods['goods_name']; ?></div>
                            <div class="p-attr"><?php echo $doGoods['goods_attr_str']; ?></div>
                          </div>
                        </a>
                      </div>
                      <div class="c-col cg-price">
                        <span class="fr cl"><em>¥</em><?php echo $doGoods['member_price']; ?></span>
                      </div>
                      <div class="c-col cg-number"><?php echo $doGoods['goods_num']; ?></div>
    ...
    有货            <input name="rec_number" type="hidden" id="37" value="0">
                    <input name="shipping_prompt" type="hidden" id="37" value="1">
                      ...
                      <div class="c-col cg-sum"><em>¥</em><?php echo $doGoods['subtotal']; ?></div>
            ...
            <div class="ck-order-remark">
              <input name="postscript" type="text" id="remarkText" maxlength="45" size="15" class="text"
                     placeholder="订单备注 限60个字" autocomplete="off"
      ...
      <div id="ECS_ORDERTOTAL">
        ...
        <div class="checkout-foot" ectype="tfoot-toolbar">
          ...
          <input name="cart_value" value="<?php echo $doGOods; ?>" type="hidden">
...
<script type="text/javascript">
  $(function () {
    ...
    /* 优惠券/储值卡/红包切换 */
    $(".ck-step-cont").slide({
      titCell: ".order-virtual-tabs li",
      mainCell: ".toggle-panel-main",
      titOnClassName: "curr",
      trigger: "click"
    });
