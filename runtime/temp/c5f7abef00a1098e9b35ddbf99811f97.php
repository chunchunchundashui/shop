                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action=""  method="post">
                                        <input type="hidden" name="id" value="<?php echo $recposInfo['id']; ?>">
                                        <div class="form-group">
                                            <label for="rec_name" class="col-sm-2 control-label no-padding-right">推荐位名称</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" placeholder="" name="rec_name" value="<?php echo $recposInfo['rec_name']; ?>" required="" type="text">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="radio" style="float:left; padding-right: 10px;">
                                                    <label>
                                                        <input type="radio" name="rec_type" <?php if($recposInfo['rec_type'] == 1): ?> checked="checked" <?php endif; ?>  value="1"  class="colored-blue">
                                                        <span class="text">商品</span>
                                                    </label>
                                                </div>
                                                <div class="radio" style="float:left;">
                                                    <label>
                                                        <input type="radio" name="rec_type" <?php if($recposInfo['rec_type'] == 2): ?> checked="checked" <?php endif; ?> value="2" class="colored-blue">
