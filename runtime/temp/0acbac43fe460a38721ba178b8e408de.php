                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action=""  method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" name="pid">
                                    ...
                                    <option <?php if($vo['allow_son'] == 0): ?> disabled="disabled" <?php endif; ?> value="<?php echo $vo['id']; ?>"><?php echo str_repeat('-', $vo['level']*8)?><?php echo $vo['cate_name']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio" style="float:left; padding-right: 10px;">
                                    <label>
                                        <input type="radio" id="show_nav" name="show_nav" value="1" class="colored-blue">
                                        <span class="text">是</span>
                                    </label>
                                </div>
                                <div class="radio" style="float:left;">
                                    <label>
                                        <input type="radio" name="show_nav" value="0" checked="checked" class="colored-blue">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea style="width: 100%;resize: none" name="keywords" id="keywords" cols="30" rows="10" class=""></textarea>
                            </div>
                        </div>
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <!--resize: none  禁止填写框拉动-->
                                <textarea name="description" style="width: 100%;resize: none" id="description" cols="30" rows="10" class=""></textarea>
                            </div>
                        </div>
                        <!--<div class="form-group">-->
