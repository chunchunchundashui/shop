                  ...
                  <div class="f-r-main f-r-m-adv">
                    <ul class="p-list">
                      ...
                      <li class="opacity_img">
                        <div class="product">
                          <div class="p-img"><a href="#" target="_blank"><img src="/shop/public/static/uploads/<?php echo $v1['mid_thumb']?>" alt="" width="140" height="140"></a></div>
                          <div class="p-name"><a href="#" title="<?php echo $v1['goods_name'];?>"><?php echo $v1['goods_name'];?></a></div>
                          <div class="p-price">
                  ...
                  <div class="f-r-main" ectype="floor_cat_347">
                    <ul class="p-list">
                      <?php foreach($v1['bestGoods'] as $k2 => $v2):?>
                        <li class="opacity_img">
                          <div class="product">
                            <div class="p-img"><a href="#" target="_blank"><img src="/shop/public/static/uploads/<?php echo $v2['mid_thumb']?>" alt="" width="140" height="140"></a></div>
                            <div class="p-name"><a href="#" title="<?php echo $v2['goods_name'];?>"><?php echo $v2['goods_name'];?></a></div>
                            <div class="p-price">
