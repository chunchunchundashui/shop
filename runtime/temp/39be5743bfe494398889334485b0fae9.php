        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加商品属性" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href = '<?php echo url('Attr/add'); ?>'"><i class="fa fa-plus"></i> Add
                </button>
                <div class="row">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php if($vo['attr_type'] == 1): ?>单选<?php else: ?>唯一<?php endif; ?></td>
                                            <td><?php echo $vo['type_name']; ?></td>
                                            <td><?php echo $vo['attr_values']; ?></td>
                                            <td align="center">
                                                <a href="<?php echo url('admin/attr/edit', ['id' => $vo['id']]); ?>"
