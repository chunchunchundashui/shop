                            ...
                            <div class="widget-body">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $orderInfo['order_total_price']; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: right;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($orderInfo['order_status'] == 0): ?>未确认<?php elseif($orderInfo['order_status'] == 1): ?>已确认<?php elseif($orderInfo['order_status'] == 2): ?>申请退款<?php elseif($orderInfo['order_status'] == 3): ?>退款成功<?php endif; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: right;">
                                        ...
                                        <td>
                                            <?php if($orderInfo['post_status'] == 0): ?>未发货<?php elseif($orderInfo['post_status'] == 1): ?>已发货<?php elseif($orderInfo['post_status'] == 2): ?>已收货<?php endif; ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align: right;">
