    ...
    <div class="article-main">
      <div class="am-hd">
        ...
        <div class="extra">
          ...
          <a href="<?php echo url('cate/index', array('id' => $cate['id'])); ?>"><?php echo $cate['cate_name']; ?></a>
          <i>&gt;</i>
          <?php endforeach; endif; else: echo "" ;endif; ?>
