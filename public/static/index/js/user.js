...
function userLogin()
{
	...
	// Ajax.call( login_url, 'username=' + username.val()+'&password='+password.val()+remember_string+'&captcha='+captcha.val()+'&dsc_token='+dsc_token.val()+'&back_act='+back_act, return_login , 'POST', 'JSON');
  Ajax.call( login_url, 'username=' + username.val()+'&password='+password.val()+remember_string, return_login , 'POST', 'JSON');
}
